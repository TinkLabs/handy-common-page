...
class CurrencyPanel extends React.Component {
  ...
  parseImgSrc = code => {
    if (constants.currencymap[code]) {
      return require("../../assets/currency/" +
        constants.currencymap[code].trim());
    }
    return "";
  };
  ...
  getImgDesc = code => {
    return constants.currencymap[code]
      .trim()
      .split("_")[1]
      .split(".")[0];
  };
    ...
    return (
      <div className={styles.currencydiv}>
        <Picker
          ...
          cols={1}
          title={
            <span className={styles.selecttitle}>Select the currency</span>
          }
          okText={
            <img className={styles.selecttitleclose} src={this.iconClose()} />
          }
          dismissText={" "}
        ...
        >
          <div
            className={styles.currencybasetitle}
            onClick={this.onBaseVisibleChange}
          >
            <img
              className={styles.titleimg}
              src={this.parseImgSrc(this.props.base)}
            />
            <span className={styles.titletext}>{this.props.base}</span>
            <img className={styles.titletextselectimg} src={this.iconMore()} />
          </div>
        </Picker>
        ...
        >
          <div
            className={styles.currencyquotetitle}
            onClick={this.onQuoteVisibleChange}
          >
            <img
              className={styles.titleimg}
              src={this.parseImgSrc(this.props.quote)}
            />
            <span className={styles.titletext}>{this.props.quote}</span>
            <img className={styles.titletext} src={this.iconMore()} />
          </div>
        </Picker>
